...
class Statistics:
    ...
    @staticmethod
    def plotFlops(flopsData, funcs, labelsToConnect, fileName, saveFolder):
...
class FlopsPlot:
    ...
    def __init__(self, title, xFunc, yFunc):
        self.title = title
...
class FlopsPlotWithLine(FlopsPlot):
    def __init__(self, title, xFunc, yFunc, labelsToConnect):
        super(FlopsPlotWithLine, self).__init__(title, xFunc, yFunc)
...
class FlopsAveragePlot(FlopsPlotWithLine):
    ...
    def __init__(self, xFunc, yFunc, labelsToConnect):
        ...
        super(FlopsAveragePlot, self).__init__(title, xFunc, yFunc, labelsToConnect)
...
class FlopsStandardPlot(FlopsPlot):
    def __init__(self, xFunc, yFunc):
        super(FlopsStandardPlot, self).__init__('Accuracy vs. Flops', xFunc, yFunc)
...
class FlopsPlotWithCondition(FlopsPlotWithLine):
    def __init__(self, title, xFunc, yFunc, labelsToConnect):
        super(FlopsPlotWithCondition, self).__init__(title, xFunc, yFunc, labelsToConnect)
...
class FlopsMaxAccuracyPlot(FlopsPlotWithCondition):
    def __init__(self, xFunc, yFunc, labelsToConnect):
        super(FlopsMaxAccuracyPlot, self).__init__('Max accuracy vs. Flops', xFunc, yFunc, labelsToConnect)
...
class MinFlopsPlot(FlopsPlotWithCondition):
    def __init__(self, xFunc, yFunc, labelsToConnect):
        super(MinFlopsPlot, self).__init__('Accuracy vs. Min Flops', xFunc, yFunc, labelsToConnect)
